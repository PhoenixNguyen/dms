...
import com.hp.rest.ForLeaveAPI.ModifyForLeaveTask;
...
public class ForLeaveAdditionActivity extends MainMenuActivity implements OnItemSelectedListener{
	...
	protected void onCreate(Bundle bundle){
		...
		calendar_content.setText("Xin nghỉ phép!");
...
//        });
	...
	private void saveSetLunch() {
		...
		ForLeave forLeave= null;
		try {
			forLeave = new ForLeave(Rest.mStaff, df.parse(date), content, "");
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		ModifyForLeaveTask addForLeave = new ModifyForLeaveTask(context, ModifyForLeaveTask.ACTION_ADD, "putForLeave", forLeave, null, null, null, this);
		addForLeave.execute();
