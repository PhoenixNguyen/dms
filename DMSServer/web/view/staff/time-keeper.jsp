                        ...
                        <table class="small reportGenerateTable" align="center" cellpadding="5" cellspacing="0" width="95%" border=0>
                            <tr>
                                <td align=center class=small>
                                    <form id="sub_form" name="filterForm" method="get" action="filter-result-timekeeping">
                            ...
                            <table align="center" border="0" cellpadding="5" cellspacing="0" width="100%" class="mailSubHeader" >
                                <tbody><tr>
                                        <td align="left" nowrap >
                                            <input class="crmbutton small create" id="btnExport" name="btnExport" value="Xuất dữ liệu Excel" type="button" onClick="location.href='export-timekeeper'" title="Xuất dữ liệu Excel" >
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="right" width="25%">
                                                            <span class="genHeaderGray">Tổng số : <span id='_reportrun_total'><s:property value="timeKeeperList.size()"/></span>  Bản ghi</span>
                                                        </td>
                                                    </tr>
