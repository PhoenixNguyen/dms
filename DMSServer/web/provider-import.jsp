...
<html>
    <head>
        <title>admin - Nhà cung cấp - Nhập dữ liệu - Phần mềm quản lý HOSCO-MANAGEMENT</title>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap="">Nhà cung cấp &gt; <a class="hdrLink" href="">Nhập liệu</a></td>
                    <td width="100%" nowrap="">
                            ...
                            <tbody><tr>
                                    <td width="75%" valign="top">
                                        ...
                                        <table align="center" cellpadding="5" cellspacing="0" width="80%" class="mailClient importLeadUI small" border="0">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2" height="50" valign="middle" align="left" class="mailClientBg  genHeaderSmall">Nhập dữ liệu Nhà cung cấp</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" align="left" valign="top" style="padding-left:40px;">
                                                        Phần mềm hỗ trợ nhập các bản ghi từ file .xls. Để bắt đầu nhập, chọn file .xls và ấn Next để tiếp tục. <a href="provider-template">(Lấy file mẫu)</a>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" width="75%">
                                                        <s:actionerror />
                                                        <s:form action="upload-provider" onsubmit="" id="upload_form" enctype="multipart/form-data" validate="true"
                                                                >  
