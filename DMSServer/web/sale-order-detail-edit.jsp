        ...
        <table border="0" cellspacing="0" cellpadding="0" width="98%" align="center">
            <tbody><tr>
                    ...
                    <td class="showPanelBg" valign="top" width="100%">
                        <div class="small" style="padding:20px">
                            ...
                            <span class="lvtHeaderText"><font color="purple">[ <s:property value="saleOrderDetail.getTakeOrderID()"/> ] </font>Bán hàng - Sửa Chi tiết Thông tin Bán hàng</span> <br>
                            ...
                            <form id="frmEditView" name="EditView" method="POST" action="update-saleorder-detail" id="sub_form" >

                                <input type="hidden" name="saleOrderDetail.serial" value="<s:property value="saleOrderDetail.getSerial()"/>">
                                            ...
                                            <td>
                                                <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                                    <tbody><tr>
                                                            ...
                                                            <td class="dvtSelectedCell" align="center" nowrap="">Thông tin bán hàng Chi tiết</td>
                                                                                    ...
                                                                                    <tbody><tr>
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="text" readonly="" name="saleOrderDetail.takeOrderID" tabindex="" value="<s:property value="saleOrderDetail.getTakeOrderID()"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                ...
                                                                                                <input readonly="" type="text" tabindex="" name="saleOrderDetail.line" id="exciseduty" value="<s:property value="saleOrderDetail.line"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="text" tabindex="" name="saleOrderDetail.productID" id="customerno" value="<s:property value="saleOrderDetail.productID"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="text" tabindex="" name="saleOrderDetail.productName" id="salesorder_no" value="<s:property value="saleOrderDetail.productName"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'"></td>
                                                                                        </tr>
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="text" tabindex="" name="saleOrderDetail.stockID" id="exciseduty" value="<s:property value="saleOrderDetail.stockID"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="text" readonly="" tabindex="" name="saleOrderDetail.unit" id="vtiger_purchaseorder" value="<s:property value="saleOrderDetail.unit"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'"></td>
                                                                                        </tr>
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="text" tabindex="" name="saleOrderDetail.exchangeRate" id="exciseduty" value="<s:property value="saleOrderDetail.exchangeRate"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="number" readonly="" tabindex="" name="saleOrderDetail.tax" id="salescommission" value="<s:property value="saleOrderDetail.tax"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                                <!--                                                                                        <input name="contact_id" type="hidden" value="0">&nbsp;<img src="themes/softed/images/select.gif" alt="Chọn" title="Chọn" language="javascript" onclick="selectContact( & quot; false & quot; , & quot; general & quot; , document.EditView)" align="absmiddle" style="cursor:hand;cursor:pointer">&nbsp;
                                                                                                                                                                                        <input type="image" tabindex="" src="themes/images/clear_field.gif" alt="Làm sạch" title="Làm sạch" language="javascript" onclick="this.form.contact_id.value = ''; this.form.contact_name.value = ''; return false;" align="absmiddle" style="cursor:hand;cursor:pointer">-->
                                                                                            </td>
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="number" tabindex="" name="discount" id="salescommission" value="<s:property value="saleOrderDetail.discount"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="number" tabindex="" name="saleOrderDetail.beforeOrderPrice" id="exciseduty" value="<s:property value="getText('{0,number,###0}',{saleOrderDetail.beforeOrderPrice})"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'"></td>
                                                                                            <td width="20%" class="dvtCellLabel" align="right">
                                                                                                <font color="red"></font>Giá bán	
                                                                                            </td>
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="number" tabindex="" name="saleOrderDetail.afterOrderPrice" id="exciseduty" value="<s:property value="getText('{0,number,###0}',{saleOrderDetail.afterOrderPrice})"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="number"  tabindex="" name="number" id="salescommission" value="<s:property value="saleOrderDetail.number"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
            <!--                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="saleOrderDetail.getCreater()"/></td>-->
                                                                                            ...
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input readonly="" type="number" tabindex="" name="saleOrderDetail.priceTotal" id="exciseduty" value="<s:property value="getText('{0,number,###0}',{saleOrderDetail.priceTotal})"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                                <!--                                                                                        <input name="account_id" type="hidden" value="139">&nbsp;<img src="themes/softed/images/select.gif" alt="Chọn" title="Chọn" language="javascript" onclick="return window.open( & quot; index.php?module = Accounts & amp; action = Popup & amp; popuptype = specific_account_address & amp; form = TasksEditView & amp; form_submit = false & amp; fromlink = & quot; , & quot; test & quot; , & quot; width = 640, height = 602, resizable = 0, scrollbars = 0 & quot; );" align="absmiddle" style="cursor:hand;cursor:pointer">
                                                                                                                                                                                        <input type="image" src="themes/images/clear_field.gif" alt="Làm sạch" title="Làm sạch" language="javascript" onclick="this.form.account_id.value = ''; this.form.account_name.value = ''; return false;" align="absmiddle" style="cursor:hand;cursor:pointer">-->
                                                                                            </td>
            <!--                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="takeOrder.getOrderEstablishDate()"/></td>-->
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <!-- This file is used to display the fields based on the ui type in detailview -->
                                                                                            <td width="30%" align="left" class="dvtCellInfo">
                                                                                                <input type="number"  tabindex="" name="promotionalProductMount" id="salescommission" value="<s:property value="saleOrderDetail.promotionalProductMount"/>" class="detailedViewTextBox" onfocus="this.className = 'detailedViewTextBoxOn'" onblur="this.className = 'detailedViewTextBox'">
                                                                                            </td>
                                                                                        ...
                                                                                        <tr style="height:25px">
                                                                                            ...
                                                                                            <td colspan="3">
                                                                                                <textarea class="detailedViewTextBox" tabindex="" onfocus="this.className = 'detailedViewTextBoxOn'" name="saleOrderDetail.note" onblur="this.className = 'detailedViewTextBox'" cols="90" rows="8"><s:property value="saleOrderDetail.note"/></textarea>
                                                                                            </td>
                                                                                        </tr>
