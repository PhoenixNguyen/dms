        ...
        <script>
            ...
            if (selected) {
                ...
                if (status == "true")
                    ...
                    alert("Không thể xóa do hóa đơn bán hàng này đã được sử dụng cho nội dung khác");
            }
        </script>
    </head>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="95%">
                                <tbody><tr>
                                        <td>
                                            ...
                                            <span class="lvtHeaderText"><font color="purple">[ <s:property value="saleOrder.id" /> ] </font>Bán hàng -  Thông tin Bán hàng </span>&nbsp;&nbsp;&nbsp;<span class="small"></span>&nbsp;<span id="vtbusy_info" style="display:none;" valign="bottom"><img src="themes/images/vtbusy.gif" border="0"></span><span id="vtbusy_info" style="visibility:hidden;" valign="bottom"><img src="themes/images/vtbusy.gif" border="0"></span>
                                        </td>
                                    </tr>
                                </tbody></table>
                            <br>
                                                ...
                                                <tbody><tr>
                                                        ...
                                                        <td class="dvtTabCache" align="right" style="width:100%">
                                                            <input title="Sửa [Alt+E]" accesskey="E" class="crmbutton small edit" onclick="
                                                                    javacript:window.location.href = 'sale-order-edit?id_so=<s:property value="saleOrder.getId()"/>'

                                                                   " type="button" name="Edit" value="&nbsp;Sửa&nbsp;">&nbsp;

                                                            <script>
                                                                var str = "delete-saleorder?id_so=<s:property value="saleOrder.Id"/>";
                                                            </script>
                                                                            ...
                                                                            <td style="padding:10px;border-right:1px dashed #CCCCCC;" width="80%">
                                                                                    ...
                                                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                                                        ...
                                                                                        <tbody><tr style="height:25px">
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Tiêu đề" onmouseover="hndMouseOver(2, 'Tiêu đề');" onmouseout="fnhide('crmspanid');" valign="top">
                                                                                                    ...
                                                                                                    &nbsp;&nbsp;<span id="dtlview_Tiêu đề">Bán hàng</span>
                                                                                                ...
                                                                                                <!-- This file is used to display the fields based on the ui type in detailview -->
                                                                                                <!--PotentialPopup-->
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Tên Cơ hội">&nbsp;<a href=""><s:property value="saleOrder.Id"/></a>
                                                                                                </td>
                                                                                            </tr>	
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Khách hàng thứ" onmouseover="hndMouseOver(1, 'Khách hàng thứ');" onmouseout="fnhide('crmspanid');" valign="top">
                                                                                                    ...
                                                                                                    &nbsp;&nbsp;<span id="dtlview_Khách hàng thứ"><s:property value="saleOrder.takeOrderDate"/></span>

                                                                                                </td>


                                                                                                <!-- Avoid to display the label Tax Class -->
                                                                                                <td class="dvtCellLabel" align="right" width="25%"><input type="hidden" id="hdtxt_IsAdmin" value="1">Ngày bán</td>


                                                                                                <!-- This file is used to display the fields based on the ui type in detailview -->

                                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="saleOrder.deliveryDate"/></td>
                                                                                            </tr>	
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Tên Báo giá">&nbsp;
                                                                                                    <a href=""><s:property value="saleOrder.customerName"/></a>
                                                                                                </td>
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Nhập hàng" onmouseover="hndMouseOver(1, 'Nhập hàng');" onmouseout="fnhide('crmspanid');" valign="top">
                                                                                                    ...
                                                                                                    &nbsp;&nbsp;<span id="dtlview_Nhập hàng"><s:property value="saleOrder.customerID"/></span>
                                                                                            ...
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Tên Liên hệ">&nbsp;
                                                                                                    <a href=""><s:property value="saleOrder.customerAddress"/> </a>
                                                                                                </td>
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Ngày liên quan" onmouseover="hndMouseOver(5, 'Ngày liên quan');" onmouseout="fnhide('crmspanid');">
                                                                                                    &nbsp;&nbsp;<span id="dtlview_Ngày liên quan">
                                                                                                        <s:property value="saleOrder.phoneNumber"/>
                                                                                                    </span>
                                                                                            ...
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <!-- Avoid to display the label Tax Class -->
                                                                                                <td class="dvtCellLabel" align="right" width="25%"><input type="hidden" id="hdtxt_IsAdmin" value="1">Chiết khấu (%)</td>
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Tình trạng" onmouseover="hndMouseOver(15, 'Tình trạng');" onmouseout="fnhide('crmspanid');">
                                                                                                    <span id="dtlview_Tình trạng"><font color=""><s:property value="saleOrder.discount"/></font></span>
                                                                                            ...
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <!-- Avoid to display the label Tax Class -->
                                                                                                <td class="dvtCellLabel" align="right" width="25%"><input type="hidden" id="hdtxt_IsAdmin" value="1">Trạng thái bán hàng</td>
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Gán cho" onmouseover="hndMouseOver(53, 'Gán cho');" onmouseout="fnhide('crmspanid');">&nbsp;<span id="dtlview_Gán cho">
                                                                                                        <b>
                                                                                                            <s:if test="saleOrder.orderStatus == 0">
                                                                                                                Đang bán hàng
                                                                                                            </s:if>
                                                                                                            <s:if test="saleOrder.orderStatus == 1">
                                                                                                                Đã duyệt
                                                                                                            </s:if>
                                                                                                            <s:if test="saleOrder.orderStatus == 2">
                                                                                                                Hoàn thành
                                                                                                            </s:if>
                                                                                                            <s:if test="saleOrder.orderStatus == 3">
                                                                                                                Hủy
                                                                                                            </s:if>
                                                                                            ...
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="saleOrder.creater"/></td>
                                                                                                ...
                                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="saleOrder.orderEstablishDate"/></td>
                                                                                            ...
                                                                                            <tr style="height:25px">
                                                                                                ...
                                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="saleOrder.editer"/></td>
                                                                                                ...
                                                                                                <td class="dvtCellInfo" align="left" width="25%&quot;">&nbsp;<s:property value="saleOrder.orderEditDate"/></td>
                                                                                    ...
                                                                                    <table border="0" cellspacing="0" cellpadding="0" width="100%" class="small">
                                                                                        ...
                                                                                        <tbody><tr style="height:25px">
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Địa chỉ thanh toán" onmouseover="hndMouseOver(24, 'Địa chỉ thanh toán');" onmouseout="fnhide('crmspanid');">&nbsp;
                                                                                                    <span id="dtlview_Địa chỉ thanh toán"><s:property value="saleOrder.deliveryAddress"/></span>
                                                                                                ...
                                                                                                <td width="25%" class="dvtCellInfo" align="left" id="mouseArea_Địa chỉ vận chuyển" onmouseover="hndMouseOver(24, 'Địa chỉ vận chuyển');" onmouseout="fnhide('crmspanid');">&nbsp;
                                                                                                    <span id="dtlview_Địa chỉ vận chuyển"><s:property value="saleOrder.shippingVehicle"/></span>
                                                                                        ...
                                                                                        <tbody><tr style="height:25px">
                                                                                                ...
                                                                                                <td width="100%" colspan="3" class="dvtCellInfo" align="left" id="mouseArea_Mô tả" onmouseover="hndMouseOver(19, 'Mô tả');" onmouseout="fnhide('crmspanid');">&nbsp;
                                                                                                    <span id="dtlview_Mô tả">
                                                                                                        <s:property value="saleOrder.note"/>
                                                                                                    </span>
                                                                                ...
                                                                                <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="crmTable" id="proTab">
                                                                                    <tbody><tr valign="top">
                                                                                        ...
                                                                                        <s:iterator value="saleOrderDetailList" status="index">
                                                                                            <tr valign="top">
                                                                                                <td class="crmTableRow small lineOnTop">
                                                                                                    <a href="edit-saleorder-detail?id_sod=<s:property value="serial"/>">Sửa</a>  | <a href='javascript:confirmdelete("delete-saleorder-detail?id_sod=<s:property value="serial"/>&id_so=<s:property value="saleOrderID"/>")'>Xóa</a>				
                                                                                                    <br>
                                                                                                </td>
                                                                                                <td class="crmTableRow small lineOnTop">
                                                                                ...
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="5" class="crmTable">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="right" class="crmTableRow small lineOnTop">(-)&nbsp;<b><a href="javascript:;" onclick="alert('Giảm giá = <s:property value="saleOrder.discount"/> %');">Chiết khấu (%)</a></b></td>
                                                                                            <td align="right" class="crmTableRow small lineOnTop"><s:property value="saleOrder.discount"/></td>
                                                                                        </tr>
                                                                                        <!--                                                                                <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="right" class="crmTableRow small lineOnTop"><s:property value="getText('{0,number,#,##0.00}',{#sum - #sum * saleOrder.discount/100})"/></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                        ...
                                        <td>						
                                            <table border="0" cellspacing="0" cellpadding="3" width="100%" class="small">
                                                <tbody><tr>
                                                        ...
                                                        <td class="dvtSelectedCellBottom" align="center" nowrap="">Bán hàng Thông tin</td>	
                                                        <td class="dvtTabCacheBottom" style="width:10px">&nbsp;</td>
                                                        <td class="dvtTabCacheBottom" align="right" style="width:100%">
                                                            <input title="Sửa [Alt+E]" accesskey="E" class="crmbutton small edit" onclick="
                                                                    javacript:window.location.href = 'sale-order-edit?id_so=<s:property value="saleOrder.Id"/>'
