    ...
    <head>
        ...
        <script>
            ...
            var status = false;
                    ...
                    alert("Không thể xóa do đơn bán đã được sử dụng cho nội dung khác");
            }
        </script>
    </head>
            ...
            <tbody><tr>
                    ...
                    <td class="showPanelBg" valign="top" width="100%" style="padding:10px;">
                        ...
                        <div id="searchAcc" style="display: block;position:relative;">
                            <form name="basicSearch" method="GET" action="search-saleorder" id="sub_form">
                                                    ...
                                                    <table border="0" cellspacing="1" cellpadding="3" width="100%" class="lvt small">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js( & quot; SalesOrder & quot; , & quot; parenttab = Inventory & amp; foldername = Default & amp; order_by = salesorder_no & amp; start = 1 & amp; sorder = ASC & amp; viewname = 26 & quot; );" class="listFormHeaderLinks">Mã Bán hàng</a></td>
                                                                <td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js( & quot; SalesOrder & quot; , & quot; parenttab = Inventory & amp; foldername = Default & amp; order_by = subject & amp; start = 1 & amp; sorder = ASC & amp; viewname = 26 & quot; );" class="listFormHeaderLinks">Ngày lập</a></td>
                                                                <td class="lvtCol"><a href="javascript:;" onclick="getListViewEntries_js( & quot; SalesOrder & quot; , & quot; parenttab = Inventory & amp; foldername = Default & amp; order_by = subject & amp; start = 1 & amp; sorder = ASC & amp; viewname = 26 & quot; );" class="listFormHeaderLinks">Ngày bán</a></td>
                                                                <td class="lvtCol">Tên Khách hàng</td>
                                                                <td class="lvtCol">Mã Khách hàng</td>
                                                                <td class="lvtCol">Địa chỉ</td>
                                                            ...
                                                            <!-- Table Contents -->
                                                            <s:iterator value="saleOrderList" status="index" var="order">
                                                                <tr bgcolor="white" onmouseover="this.className = 'lvtColDataHover'" onmouseout="this.className = 'lvtColData'" id="row_201" class="lvtColData">
                                                                    ...
                                                                    <td onmouseover=""><a href="sale-order-detail?id_so=<s:property value="id"/>" title="Accounts"><s:property value="id" /></a><span type="vtlib_metainfo" vtrecordid="201" vtfieldname="salesorder_no" vtmodule="SalesOrder" style="display:none;"></span></td>
                                                                    ...
                                                                    <td onmouseover=""><a href="sale-order-edit?id_so=<s:property value="id"/>">Sửa</a>  | <a href='javascript:confirmdelete("delete-saleorder?id_so=<s:property value="id"/>")'>Xóa</a></td>
                                                                </tr>
                                                            </s:iterator>
                                                        </tbody>
                                                    </table>
